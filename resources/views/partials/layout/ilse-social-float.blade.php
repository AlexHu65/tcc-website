...
@if (count($items))
    <div class="ilse-social-float" data-ilse-social-float aria-live="polite">
        <ul class="ilse-social-float__menu" id="ilse-social-float-menu" role="list" aria-hidden="true">
        ...
        <button
            ...
            aria-label="Abrir enlaces a redes sociales"
        >
